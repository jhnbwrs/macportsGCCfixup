...
/* gcc.h doesn't seem to be included with the macports version of gcc, so 
 * instead we are just going to drop the defines in here that we need.  These
 * come from gcc 4.2, I will try and find what the equivalent would be for 
 * 4.6 later -- TODO */
